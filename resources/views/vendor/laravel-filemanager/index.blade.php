...
<head>
  ...
  <link rel="stylesheet" href="{{ url('/vendor/unisharp/laravel-filemanager/public/css/cropper.min.css') }}">
  <link rel="stylesheet" href="{{ url('/vendor/unisharp/laravel-filemanager/public/css/lfm.css') }}">
...
<body>
  ...
  <script src="{{ url('/vendor/unisharp/laravel-filemanager/public/js/cropper.min.js') }}"></script>
  <script src="{{ url('/vendor/unisharp/laravel-filemanager/public/js/jquery.form.min.js') }}"></script>
